              ...
              <div className="flexbox flexbox--direction-row flexbox--column-t991">
                <div className="company-item__heading  company-item__heading--RIGHT flex-1">
                  <div className="sticky-block flexbox--mb20-t991">
                    ...
                    <div className="company-item__text  index-block__preview">Компания Import Euro Car специализируется на поставке автомобилей среднего и премиум-класса из Европы. Работаем под заказ. </div>
